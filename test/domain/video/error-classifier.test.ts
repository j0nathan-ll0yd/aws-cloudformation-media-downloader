...
// Mock the custom errors module before importing the classifier
vi.mock('#errors/custom-errors.js', () => ({
...
const {CookieExpirationError} = await import('#errors/custom-errors.js')
const {classifyVideoError, calculateExponentialBackoff, isRetryExhausted} = await import('#domain/video/errorClassifier.js')
