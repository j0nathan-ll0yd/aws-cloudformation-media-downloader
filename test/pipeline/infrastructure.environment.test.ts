...
const excludedSourceVariables: Record<string, number> = {
  ...
  DSQL_ENDPOINT: 1, // Aurora DSQL endpoint
...
// Variables from common_lambda_env local in infra/main.tf that are merged into all lambdas
// These are infrastructure-level settings, not accessed by source code
// Keep in sync with infra/main.tf locals.common_lambda_env
