...
export interface AwsS3BucketACL {
  Files: AwsS3BucketACLFile[]
}

export interface AwsS3BucketACLFile {
  acl: string
  bucket: string
}
...
const typeMap: any = {
  ...
  Aws: o([{json: 'current', js: 'current', typ: a(r('Current'))}], false),
  Current: o([], false),
  ...
  APIGatewayAuthorizerRolePolicyElement: o([{json: 'statement', js: 'statement', typ: a(r('APIGatewayAuthorizerStatement'))}], false),
  ...
  APIGatewayCloudwatchRole: o([{json: 'statement', js: 'statement', typ: a(r('APIGatewayCloudwatchRoleStatement'))}], false),
  ...
  AssumeRole: o([{json: 'statement', js: 'statement', typ: a(r('LambdaAssumeRoleStatement'))}], false),
  ...
  RegisterDevice: o([{json: 'statement', js: 'statement', typ: a(r('RegisterDeviceStatement'))}], false),
  ...
  UserSubscribe: o([{json: 'statement', js: 'statement', typ: a(r('UserSubscribeStatement'))}], false),
  ...
  HTTP: o([{json: 'icanhazip', js: 'icanhazip', typ: a(r('Icanhazip'))}], false),
  Icanhazip: o([{json: 'url', js: 'url', typ: ''}], false),
  LocalFile: o([{json: 'DefaultFile', js: 'DefaultFile', typ: a(r('LocalFileDefaultFile'))}], false),
  LocalFileDefaultFile: o([{json: 'filename', js: 'filename', typ: ''}], false),
  SopsFile: o([{json: 'secrets', js: 'secrets', typ: a(r('Secret'))}], false),
  Secret: o([{json: 'source_file', js: 'source_file', typ: ''}], false),
  Output: o(
    [
  ...
  Provider: o([{json: 'aws', js: 'aws', typ: a(r('Aw'))}], false),
  Aw: o(
    [
  ...
  Resource: o(
    [
      ...
      {json: 'aws_s3_bucket_acl', js: 'aws_s3_bucket_acl', typ: r('AwsS3BucketACL')},
  ...
  AwsAPIGatewayAccount: o([{json: 'Main', js: 'Main', typ: a(r('AwsAPIGatewayAccountMain'))}], false),
  AwsAPIGatewayAccountMain: o([{json: 'cloudwatch_role_arn', js: 'cloudwatch_role_arn', typ: ''}], false),
  AwsAPIGatewayAPIKey: o([{json: 'iOSApp', js: 'iOSApp', typ: a(r('AwsAPIGatewayAPIKeyIOSApp'))}], false),
  ...
  AwsAPIGatewayAuthorizer: o([{json: 'ApiGatewayAuthorizer', js: 'ApiGatewayAuthorizer', typ: a(r('APIGatewayAuthorizer'))}], false),
  ...
  AwsAPIGatewayDeployment: o([{json: 'Main', js: 'Main', typ: a(r('AwsAPIGatewayDeploymentMain'))}], false),
  ...
  Lifecycle: o([{json: 'create_before_destroy', js: 'create_before_destroy', typ: true}], false),
  MainTriggers: o([{json: 'redeployment', js: 'redeployment', typ: ''}], false),
  ...
  ResponseTemplates: o([{json: 'application/json', js: 'application/json', typ: ''}], false),
  ...
  AwsAPIGatewayMethodSettings: o([{json: 'Production', js: 'Production', typ: a(r('AwsAPIGatewayMethodSettingsProduction'))}], false),
  ...
  AwsAPIGatewayRESTAPI: o([{json: 'Main', js: 'Main', typ: a(r('AwsAPIGatewayRESTAPIMain'))}], false),
  ...
  EndpointConfiguration: o([{json: 'types', js: 'types', typ: a('')}], false),
  AwsAPIGatewayStage: o([{json: 'Production', js: 'Production', typ: a(r('AwsAPIGatewayStageProduction'))}], false),
  ...
  AwsAPIGatewayUsagePlan: o([{json: 'iOSApp', js: 'iOSApp', typ: a(r('AwsAPIGatewayUsagePlanIOSApp'))}], false),
  ...
  AwsAPIGatewayUsagePlanKey: o([{json: 'iOSApp', js: 'iOSApp', typ: a(r('AwsAPIGatewayUsagePlanKeyIOSApp'))}], false),
  ...
  AwsCloudfrontDistribution: o([{json: 'Production', js: 'Production', typ: a(r('AwsCloudfrontDistributionProduction'))}], false),
  AwsCloudfrontDistributionProduction: o(
    [
      {json: 'comment', js: 'comment', typ: ''},
      {json: 'default_cache_behavior', js: 'default_cache_behavior', typ: a(r('DefaultCacheBehavior'))},
      {json: 'enabled', js: 'enabled', typ: true},
      {json: 'origin', js: 'origin', typ: a(r('Origin'))},
  ...
  DefaultCacheBehavior: o(
    [
      ...
      {json: 'forwarded_values', js: 'forwarded_values', typ: a(r('ForwardedValue'))},
  ...
  Cooky: o([{json: 'forward', js: 'forward', typ: ''}], false),
  ...
  Restriction: o([{json: 'geo_restriction', js: 'geo_restriction', typ: a(r('GeoRestriction'))}], false),
  GeoRestriction: o(
    [
  ...
  ViewerCertificate: o([{json: 'cloudfront_default_certificate', js: 'cloudfront_default_certificate', typ: true}], false),
  ...
  AwsDynamodbTable: o([{json: 'MediaDownloader', js: 'MediaDownloader', typ: a(r('MediaDownloader'))}], false),
  MediaDownloader: o(
    [
  ...
  AwsLambdaEventSourceMapping: o([{json: 'SendPushNotification', js: 'SendPushNotification', typ: a(r('AwsLambdaEventSourceMappingSendPushNotification'))}], false),
  ...
  APIGatewayAuthorizerEnvironment: o([{json: 'variables', js: 'variables', typ: r('PurpleVariables')}], false),
  PurpleVariables: o(
    [
  ...
  TracingConfig: o([{json: 'mode', js: 'mode', typ: r('Mode')}], false),
  StartFileUpload: o(
    [
      {json: 'depends_on', js: 'depends_on', typ: a('')},
      {json: 'description', js: 'description', typ: ''},
  ...
  StartFileUploadEnvironment: o([{json: 'variables', js: 'variables', typ: r('FluffyVariables')}], false),
  FluffyVariables: o(
    [
  ...
  AwsLambdaLayerVersion: o([{json: 'YtDlp', js: 'YtDlp', typ: a(r('YtDLP'))}], false),
  YtDLP: o(
    [
  ...
  AwsS3Bucket: o([{json: 'Files', js: 'Files', typ: a(r('AwsS3BucketFile'))}], false),
  AwsS3BucketFile: o([{json: 'bucket', js: 'bucket', typ: ''}], false),
  AwsS3BucketACL: o([{json: 'Files', js: 'Files', typ: a(r('AwsS3BucketACLFile'))}], false),
  AwsS3BucketACLFile: o(
    [
      {json: 'acl', js: 'acl', typ: ''},
      {json: 'bucket', js: 'bucket', typ: ''}
    ],
  ...
  AwsS3BucketNotification: o([{json: 'Files', js: 'Files', typ: a(r('AwsS3BucketNotificationFile'))}], false),
  ...
  AwsS3Object: o([{json: 'DefaultFile', js: 'DefaultFile', typ: a(r('AwsS3ObjectDefaultFile'))}], false),
  ...
  AwsSnsPlatformApplication: o([{json: 'OfflineMediaDownloader', js: 'OfflineMediaDownloader', typ: a(r('OfflineMediaDownloader'))}], false),
  ...
  AwsSnsTopic: o([{json: 'PushNotifications', js: 'PushNotifications', typ: a(r('PushNotification'))}], false),
  PushNotification: o([{json: 'name', js: 'name', typ: ''}], false),
  AwsSqsQueue: o([{json: 'SendPushNotification', js: 'SendPushNotification', typ: a(r('AwsSqsQueueSendPushNotification'))}], false),
  ...
  SendPushNotificationTags: o([{json: 'Environment', js: 'Environment', typ: ''}], false),
  NullResource: o([{json: 'DownloadYtDlpBinary', js: 'DownloadYtDlpBinary', typ: a(r('DownloadYtDLPBinary'))}], false),
  ...
  Provisioner: o([{json: 'local-exec', js: 'local-exec', typ: a(r('LocalExec'))}], false),
  LocalExec: o([{json: 'command', js: 'command', typ: ''}], false),
  DownloadYtDLPBinaryTriggers: o([{json: 'version', js: 'version', typ: ''}], false),
  Terraform: o([{json: 'required_providers', js: 'required_providers', typ: a(r('RequiredProvider'))}], false),
  RequiredProvider: o(
    [
  ...
  APIGatewayAuthorizerType: ['zip'],
  AttributeType: ['N', 'S'],
  DynamoDBTableName: ['${aws_dynamodb_table.MediaDownloader.name}'],
  Runtime: ['nodejs22.x'],
  Mode: ['Active'],
  Action: ['lambda:InvokeFunction'],
  PrincipalEnum: ['apigateway.amazonaws.com', 'events.amazonaws.com', 's3.amazonaws.com']
}
