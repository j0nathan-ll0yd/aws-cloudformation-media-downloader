...
export const feedlyWebhookSchema = z.object({
...
export const userLoginSchema = z.object({idToken: z.string()})

export const userLoginResponseSchema = z.object({token: z.string()})

export const userRegistrationSchema = z.object({idToken: z.string(), firstName: z.string().optional(), lastName: z.string().optional()})

export const userRegistrationResponseSchema = z.object({token: z.string()})

export const userSubscriptionSchema = z.object({endpointArn: z.string(), topicArn: z.string()})
