...
import {createPlatformEndpoint, listSubscriptionsByTopic, unsubscribe} from '../../../lib/vendor/AWS/SNS.js'
...
import {registerDeviceConstraints} from '../../../util/constraints.js'
import {upsertDeviceParams, userDevicesParams} from '../../../util/dynamodb-helpers.js'
import {getUserDetailsFromEvent, lambdaErrorResponse, logDebug, logInfo, response, verifyPlatformConfiguration} from '../../../util/lambda-helpers.js'
import {SubscriptionsList} from 'aws-sdk/clients/sns'
import {providerFailureErrorMessage, UnexpectedError} from '../../../util/errors.js'
import {getUserDevices, subscribeEndpointToTopic} from '../../../util/shared.js'
