...
import {logDebug, logInfo, putMetrics, response, wrapApiHandler, WrapperMetadata} from '#util/lambda-helpers'
 ...
 */
export const handler = withXRay(wrapApiHandler(async (_event: ScheduledEvent, context: Context, _metadata: WrapperMetadata): Promise<APIGatewayProxyResult> => {
