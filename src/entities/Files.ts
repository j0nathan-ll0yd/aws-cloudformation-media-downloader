 ...
 * This entity manages permanent media file metadata.
 *
 * Note: Transient download state (retries, errors, scheduling) is managed
 * by the separate FileDownloads entity. This separation ensures:
 * - Clean data model: Files = permanent metadata only
 * - No pollution of file records with transient download state
 * - Better queryability for both use cases
 *
