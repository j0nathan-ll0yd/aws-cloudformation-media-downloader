...
export const Files = new Entity({
  ...
  attributes: {
    ...
    status: {type: ['PendingMetadata', 'PendingDownload', 'Scheduled', 'Downloaded', 'Failed'] as const, required: true, default: 'PendingMetadata'},
    ...
    maxRetries: {type: 'number', required: false, default: 5},
    lastError: {type: 'string', required: false},
    scheduledPublishTime: {type: 'number', required: false},
