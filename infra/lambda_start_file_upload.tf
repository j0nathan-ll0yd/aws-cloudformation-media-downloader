...
module "lambda_start_file_upload" {
  ...
  environment_variables = merge(local.common_lambda_env, {
      ...
      SNS_QUEUE_URL = module.queue_send_push_notification.queue_url
  ...
  inline_policies = {
    "SQSSend_SendPushNotification" = jsonencode({
      ...
      Statement = [{
        ...
        Resource = module.queue_send_push_notification.queue_arn
      }]
    })
    "S3Access" = jsonencode({
      Version = "2012-10-17"
  ...
  sqs_trigger_arn     = module.queue_download.queue_arn
