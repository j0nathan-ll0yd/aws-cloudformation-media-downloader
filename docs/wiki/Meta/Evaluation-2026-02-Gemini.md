...
2.  **Prompt to add a new MCP tool for code generation:**
    ...
    > 4.  Update the Terraform configuration (`infra/{lambdaName}.tf`) to define the new Lambda resource and its basic IAM role.
